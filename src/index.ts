...
import type { OBJ } from "./helpers/parseOBJ.js";
...
if (!canvasContainer) { handleError("Unable to find the canvas_container"); }



const numberOfCanvases = 1;
const canvasEngines:CanvasGameEngine[] = [];
...
const selectedObject:OBJ.ForRender = objFiles.triangle_Chicken;
